...
- Name: edge-cases.spec.ts >> Blockchain Certificate Platform - UI Edge Cases >> 2. Login Edge Cases (Wrong credentials, SQLi attempt)
- Location: e2e\edge-cases.spec.ts:45:7
